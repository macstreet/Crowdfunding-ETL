...
SELECT bac.email, bac.first_name, bac.last_name, cam.cf_id, cam.company_name, cam.description, cam.end_date,
(cam.goal-cam.pledged) AS "Left of Goal"
INTO email_backers_remaining_goal_amount
FROM backers as bac
JOIN campaign AS cam ON cam.cf_id=bac.cf_id
ORDER BY bac.last_name, bac.first_name ASC;
